...
%                  Presentation info	              %
% --------------------------------------------------- %
\title[Dissecting the moat regime at low energies I]{\LARGE \textbf{Dissecting the moat regime at low energies I: Renormalization and the phase structure}}
%\subtitle{Universidade Tecnológica Federal do Paraná}
\author[Shi Yin]{\LARGE \negrito{Shi Yin}}
\institute[JLU]{
...
\raisebox{-0.2cm}{\includegraphics[scale=.2, clip]{figuras/imgpsh_fullsize_anim.jpg}}&
\includesvg[height=40pt]{figuras/CRC-TR211long.svg}
\end{tabular}}
...
\begin{frame}{QCD phase diagram}
        ...
        %\begin{column}{1\textwidth}
            \centering{\includegraphics[width=0.87\linewidth]{figuras/chap1_phase20240311.pdf}}\\~\
...
\section{Moat regime in Low energy}

\subsection{Quark-Meson Model}
\begin{frame}{Quark-Meson Model}
